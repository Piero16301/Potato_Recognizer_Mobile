...
class _MyAppState extends State<MyApp> {
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          ...
          SpeedDialChild(
            ...
            backgroundColor: Colors.blue,
            foregroundColor: Colors.white,
            label: 'YoloV11 on Image',
            labelStyle: const TextStyle(fontSize: 18.0),
            onTap: () {
              setState(() {
                option = Options.imageV11;
              });
            },
          ),
          SpeedDialChild(
  ...
  Widget task(Options option) {
    ...
    if (option == Options.imageV11) {
      return YoloImageV11(vision: vision);
    }
...
class YoloImageV11 extends StatefulWidget {
  final FlutterVision vision;
  const YoloImageV11({super.key, required this.vision});

  @override
  State<YoloImageV11> createState() => _YoloImageV11State();
}

class _YoloImageV11State extends State<YoloImageV11> {
  late List<Map<String, dynamic>> yoloResults;
  File? imageFile;
  int imageHeight = 1;
  int imageWidth = 1;
  ...
  Future<void> loadYoloModel() async {
    await widget.vision.loadYoloModel(
        labels: 'assets/labels.txt',
        modelPath: 'assets/yolov11n.tflite',
